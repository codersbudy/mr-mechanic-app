            ...
            <div className='row'>
                ...
                <div className='col-8  outerDiv'>
                    <div className='imageDiv'>
                        <img src={shop.photo} className="img-fluid image" alt="..." />
                    </div>
                    ...
                    <div className='row p-4' >
                        ...
                        <div className='col-6 backDiv' >
                            <Link to="/customerHome" className="btn back margin-right-2" id="btn" ><i className="fa fa-arrow-left" aria-hidden="true"></i>Back</Link>
                        </div>
