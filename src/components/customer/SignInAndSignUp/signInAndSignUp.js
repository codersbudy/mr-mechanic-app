...
function CustomerSignInAndSignUp() {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            if (response.data.status) {
                ...
                socket.emit('join',response.data.customer);
    ...
    return <>
        <ToastContainer />
        <div className="modal fade" id="customerModel" data-bs-backdrop="static" data-bs-keyboard="false" tabIndex="-1"
                                    ...
                                    <div className="" style={{ marginTop: "2vw" }}>
                                        <div style={{ marginLeft: "1.5vw" }}>
                                            ...
                                            <div style={{ fontSize: 16, marginTop: "1.5vw" }} >
                                                <button  data-bs-dismiss="modal"  aria-label="Close" type="submit" dis className="btn p-2" id="signinBtn" > Login </button>
