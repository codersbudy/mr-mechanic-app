...
import { setMechanics, setShopkeeper, setShops } from "../../../redux-config/shopkeeperSlice";
...
function ShopKeeperSignInAndSignUp() {
    ...
    const signInHandler = async (event) => {
        ...
        try {
            ...
            const response2 = await axios.post(api.SHOPKEEPER_GETSHOPS, {shopkeeperId:response.data.result._id});
            console.log(response2);
            toast.success("Log In successfully...");
            dispatch(setShopkeeper(response.data.result));
            socket.emit('shopkeeper-join',response.data.result);

            dispatch(setShops(response2.data.shops));
            dispatch(setMechanics(response2.data.mechanics));
    ...
    return <>
        <ToastContainer />
        <div className="modal fade" id="shopKeeperModel" data-bs-backdrop="static" data-bs-keyboard="false" tabIndex="-1"
                    ...
                    <div className="container-fluid m-0 p-0 box-content" id="box-content-shopkeeper">
                        ...
                        {!shopFlag && <div className="row r1 p-0 m-0 outer1">
                            ...
                            <div className="col-md-8 col-sm-12 secondside">
                                <div className="close">
                                    <button type="button" id="closebutoon" className="btn-close" data-bs-dismiss="modal"
                                    ...
                                    <div className="" style={{ marginTop: "2vw" }}>
                                        <div style={{ marginLeft: "1.5vw" }}>
                                            ...
                                            <div style={{ fontSize: 16, marginTop: "8vw" }}>
                                                ...
                                                <span id="checkboxcontaint">I agree to the <a href="" className="linkHover" id="termcondition">Term and condition.</a></span>
