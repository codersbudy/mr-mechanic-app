...
function Shop() {
  ...
  var rating = (r) => {
    ...
    for (let i = 0; i < Math.trunc(r); i++)
      count = <>{count}<i className="text-warning fa fa-star a" /></>
    if (((r / 0.5) % 2))
      count = <>{count}<i className="text-warning fa fa-star-half a" /></>
    return count;
  }
          ...
          <div className="row d-flex justify-content-center align-items-center h-100">
            <div className="col">
              ...
              <div className="col-lg-12">
                ...
                */}
                  {!isLoading &&
                    shopList.map((shop, index) => <div className="card1 mb-3 ">
                      <div className="card-body">
                        <div className="d-flex justify-content-between">
                          <div className="d-flex flex-row align-items-center">
                            ...
                            <div className="ms-3" style={{ width: 300 }}>
                              <h4>{shop.shopName}</h4>
                              <p className="small mb-0"> {shop.address.slice(0, 50)}</p>
                            </div>
                          </div>
                          <div className="d-flex flex-row align-items-center">
                            <div className="row ratdiv">
